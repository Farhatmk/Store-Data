...
Select Concat(Name,' ',Surname) 'Name_Surname' from Student
--OR
Select Name+' '+Surname as Name_Surname from Student
...
Select Name, Surname, Class, Gender from Student where 
(Gender = 'M' and Class='9Math') or (Gender = 'F' and Class = '9His')
...
Select * from Student where YEAR(BirthYear) = 1989
Select * from Student